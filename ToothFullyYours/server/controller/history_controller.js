...
exports.create = (req,res)=>{
    ...
    const history = new Historydb({
        p_patientID: req.body.patientID,
        p_name: req.body.name,
        p_email: req.body.email,
        p_phoneNum: req.body.phoneNum,
        p_transNo: req.body.transNo,
        p_ap_date: req.body.phdate,
        p_ap_time: req.body.phtime,
        p_toothNo: req.body.toothNo,
        p_procedure: req.body.procedure,
        p_amount: req.body.payments,
